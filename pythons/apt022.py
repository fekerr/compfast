    ...
    for path in paths:
        try:
            ...
            data.append({
                ...
                "Runtimes (s)": f"{first_runtime:.3f}, {second_runtime:.3f} ({estimated_iterations})"
            })
...
print("\nInterpreter                    Version Info                                           Runtimes (s)")
print("===========                    ============                                           ============")
for index, item in enumerate(data, start=1):
    print(f"{index:2}. {item['Interpreter']:<25} {item['Version']:<55} {item['Runtimes (s)']:>19}")
