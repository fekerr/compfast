    ...
    for path in paths:
        try:
            ...
            data.append({
                ...
                "First Runtime (s)": f"{first_runtime:.3f}",
                "Second Runtime (s)": f"{second_runtime:.3f}"
            })
...
print("\nInterpreter                    Version Info                                           First Runtime (s)  Second Runtime (s)")
print("===========                    ============                                           =================  ==================")
for index, item in enumerate(data, start=1):
    print(f"{index:2}. {item['Interpreter']:<25} {item['Version']:<55} {item['First Runtime (s)']:>19}  {item['Second Runtime (s)']:>19}")
